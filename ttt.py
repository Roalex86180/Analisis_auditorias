...
def process_data(uploaded_file):
    ...
    # Resto de las secciones de observaciones detalladas
    # ...
...
st.title("Cargar archivo Excel para análisis de auditorías")
uploaded_file = st.file_uploader("Sube tu archivo Excel", type=["xlsx"])

if uploaded_file is not None:
    kpis, empresa_kpis_df, total_auditorias, df = process_data(uploaded_file)
